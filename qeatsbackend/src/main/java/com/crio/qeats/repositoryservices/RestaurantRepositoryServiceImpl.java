...
public class RestaurantRepositoryServiceImpl implements RestaurantRepositoryService {
  ...
  public List<Restaurant> findAllRestaurantsCloseBy(Double latitude, Double longitude, LocalTime currentTime,
    ...
    System.out.println(res.get(0).getOpensAt());
    for (RestaurantEntity e : res) {
      Restaurant xx = new Restaurant();
      xx.setAttributes(e.getAttributes());
      xx.setClosesAt(e.getClosesAt());
      xx.setOpensAt(e.getOpensAt());
      xx.setRestaurantId(e.getRestaurantId());
      xx.setLatitude(e.getLatitude());
      xx.setCity(e.getCity());
      xx.setImageUrl(e.getImageUrl());
      xx.setName(e.getName());
      xx.setLongitude(e.getLongitude());
